...
function shortDate(ms: number) {
  return formatDateTime(ms).split(",")[0];
}
        ...
        {sessions.length === 0 ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-5">
              <Stat
                label="Avg players"
                value={extras.avgPlayersPerNight.toFixed(1)}
              />
              <Stat
                label="Buy-ins all time"
                value={String(extras.totalBuyInCount)}
              />
              <Stat
                label="Rebuy rate"
              ...
              <Stat
                ...
                value={formatINR(extras.avgPotPerPlayer)}
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 mb-5">
              ...
              <Stat
                label="Avg night"
                value={`${extras.avgHoursPlayed.toFixed(1)}h`}
              />
              {extras.assumedDurationSessions > 0 && (
                <p className="col-span-2 text-white/30 text-xs -mt-0.5">
                  ...
                  {extras.assumedDurationSessions === 1 ? "" : "s"} counted at
                  an assumed 4 hours, since those games predate the app.
                </p>
              )}
            </div>
  ...
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      <div className="text-right shrink-0">
        ...
        <div className="text-white/30 text-xs">{shortDate(at)}</div>
      </div>
    </div>
  );
}
